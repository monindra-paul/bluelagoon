...
<div class="page-content">
	...
	<div class="section-full  special-offer-block2 overlay-wraper bg-repeat p-t100 p-b70 " style="background-image:url({{asset('asset/images/background/bg-6.jpg')}};)">
		<div class="overlay-main bg-white opacity-01"></div>
		<div class="left-larg-pic mr-5">
			<div class="wt-media m-3">
			...
			<div class="row">
				...
				<div class="col-md-9 col-sm-9 m-b30">
					<div class="awesome-counter text-right">
						...
						<h2 class="font-60 font-weight-600"><span class="site-text-primary">About Us
							</span></h2>
						<p class="ml-4 pl-4">The Blue lagoon is a family-owned and operated salon dedicated to making your family feel extraordinary. <br> With 8+ years of expertise in the industry, we have become a trusted name in the community.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="section-full p-t100 p-b70 bg-bottom-center bg-full-width bg-no-repeat" style="background-image:url(images/background/bg-1.png);">
		<div class="container ">
			<div class="section-head text-center">
				<h2><span class="site-text-primary">Services </span> We Provide</h2>
				...
				<p>
					The Blue Lagoon, the best beauty salon in South Kolkata provides you with every sort of beauty treatments and plenty of styles for your hair and makeup with the best quality products!
				</p>
	...
	<div class="section-full bg-white p-t100 p-b70 bg-bottom-right bg-no-repeat" style="background-image:url(images/stone-spa.png)">
		<div class="container">
			<!-- TITLE START-->
			<div class="section-head text-center">
				<h2><span class="site-text-primary">Our</span> Special Offers</h2>
				<div class="wt-separator-outer ">
					<div class="wt-separator style-icon">
						<i class="fa fa-leaf text-black"></i>
						<span class="separator-left site-bg-primary"></span>
				...
				<p>Proving to be the best salon in Kolkata, serves impeccable services that includes multiple haircut options, hair colour and hair treatment processes, facial, waxing, manicure, pedicure, to what not. Unwind yourselves at the salon, as we offer you with all sorts of facilities for your hair and skin as well.</p>
			</div>
			<!-- TITLE END-->
					...
					<div class="col-lg-3 col-md-6 col-sm-6 m-b30">
						<div class="wt-box bg-white wt-product-box">
							...
							<div class="wt-info p-a20 text-center">
								<h3>50% Discount off all Hair Cut</h3>
								...
								<div class="p-t10">
									<a href="#" class="site-button text-uppercase radius-sm font-weight-700 button-md">Contact Us</a>
								</div>
							</div>
						</div>
					</div>
