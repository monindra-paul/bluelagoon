                        ...
                        <form>                          
                           ...
                           <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ $contacts->phone }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                   <!-- <a href="{{url('contactapplication')}}"> <button type="" class="btn btn-primary">Back to Applications</button></a> -->
                                </div>
                            </div>
